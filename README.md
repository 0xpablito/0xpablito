...
### 🚀 En reconversion professionnelle pour devenir Administrateur Réseau

En reconversion vers le métier d’administrateur réseau, je développe mes compétences à travers des labs techniques concrets, me permettant d’acquérir une expérience proche des environnements d’entreprise et de mettre en pratique mes connaissances.
...
| **Microsoft AZ-104** | 🏗️ En cours | ![Azure](https://img.shields.io/badge/Azure-AZ--104-informational?style=flat-square&logo=microsoft-azure) |
...
#### 🌐 Lab-2-GNS3 — Infrastructure 3-Tier Virtualisée
**Simulation d'un environnement de production réel via GNS3 et VMware Workstation.**
* **Objectif :** Déployer une architecture hiérarchique utilisant des images IOS réelles et des serveurs Windows Core.
...
![Pédagogie](https://img.shields.io/badge/Pédagogie-Vulgarisation-brightgreen?style=flat-square)
![Service](https://img.shields.io/badge/Sens_du_service-Client-brightgreen?style=flat-square)
![Analyse](https://img.shields.io/badge/Esprit_d'analyse-Logic-brightgreen?style=flat-square)
![Autonomie](https://img.shields.io/badge/Autonomie-Proactif-brightgreen?style=flat-square)
